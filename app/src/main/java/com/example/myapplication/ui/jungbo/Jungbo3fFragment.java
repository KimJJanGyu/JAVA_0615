...
public class Jungbo3fFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView3.setOnClickListener(v -> handleTextViewClick(textView12, R.drawable.ic_maker));
        textView3.setOnClickListener(v -> handleTextViewClick(textView13, R.drawable.ic_maker));

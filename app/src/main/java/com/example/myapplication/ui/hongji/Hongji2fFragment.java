...
public class Hongji2fFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView textView1 = view.findViewById(R.id.hongji2f_1);
        TextView textView2 = view.findViewById(R.id.hongji2f_2);
        TextView textView3 = view.findViewById(R.id.hongji2f_3);
        TextView textView4 = view.findViewById(R.id.hongji2f_4);
    ...
    private void handleTextViewClick(TextView textView, int imageResId) {
        if (lastClickedTextView != null && lastClickedTextView == textView) {
            ...
            if (textView.getId() == R.id.hongji2f_1) {
                params.leftMargin = 220;
                params.topMargin = 100;
            } else if (textView.getId() == R.id.hongji2f_2) {
                params.leftMargin = 450;
                params.topMargin = 100;
            } else if (textView.getId() == R.id.hongji2f_3) {
                params.leftMargin = 500;
                params.topMargin = 400;
            } else if (textView.getId() == R.id.hongji2f_4) {
